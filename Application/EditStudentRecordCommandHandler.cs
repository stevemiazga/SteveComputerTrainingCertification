...
{
    public class EditStudentRecordCommandHandler : IRequestHandler<EditStudentRecordCommand, bool>
    {
        private readonly IStudentRepository _studentRepository;
        private readonly ICertificationRepository _certificationRepository;

        public EditStudentRecordCommandHandler(IStudentRepository studentRepository, ICertificationRepository certificationRepository)
        {
            _studentRepository = studentRepository;
            _certificationRepository = certificationRepository;
        }

        public async Task<bool> Handle(EditStudentRecordCommand command, CancellationToken cancellationToken)
        {
            ...
            student.RemoveCoursesTaken();
            student.RemoveExamsPassed();
            student.RemoveCertificationsObtained();
